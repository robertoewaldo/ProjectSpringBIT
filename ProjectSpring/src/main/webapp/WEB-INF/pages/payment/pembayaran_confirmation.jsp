...
<body>
	...
	<form:form method = "POST" action = "/ProjectSpring/pembayaran/confirmed">
		<table>
			<tr>
				<td>Pembayaran:</td>
				<td>
			...
			<tr>
				<td>No Telp:</td>
				<td><input type="text" id="phone_input" class="input_number" name="phone_num" pattern="[08]{2}[0-9]{8,10}" required="required" readonly="readonly" value="${payment.phone_num}"/></td>
			</tr>
			<tr>
				<td>Nominal:</td>
				<td><input type="number" class="input_number" name="amount" required="required" min="10000" max="1000000" step="5000" readonly="readonly" value="${payment.amount}"/></td>
			</tr>
			<tr>
				<td>Apply1:</td>
